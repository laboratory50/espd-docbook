...
ЕСПД. Так же имеется библиотека стилей ЕСКД. В ней содержатся стили оформления
...
Параметр `<?dbfo row-height="размер" ?>` предназначен для задания необходимой высоты строки
в таблице. Для стиля ЕСКД в таблицах, имеющих продолжение на следующей странице, добавляются
слова "Продолжение" и "Окончание" (в зависимости от необходимости).

## Лист регистрации изменений

В версии 2.0 появилась возможность создания листа утверждения по требованиям ЕСКД.
...
Количество листов в документе выставляется разными способами в зависимости от наличия листа регистрации изменений.
Если в документе приcутствует ЛРИ, при его формировании выставляется `id="END-OF-DOCUMENT"`.
Если документ не содержит ЛРИ, в его последнем разделе ставится `<?lastpage?>`.
