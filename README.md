...
соответствующие шрифты (перечислены в Makefile).
 ...
 *  Использование русских букв. Для корректной работы нужен XSLT-транслятор
    Saxon + Xerces.
 *  Появилась возмжность выбрать символ в нумерации: `)` или точка. По умолчанию
    ставится `)`. Чтобы появилась точка, необходимо в <orderedlist>
    указать role="dot".
