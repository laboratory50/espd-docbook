...
Для всех листов утверждения оформление устанавливается набором стилевых параметров `lu.style`, а для титульных страниц — набором стилевых параметров `espd.titlepage.style`.
